...
function CoreNavVerticalCollapse(props) {
    ...
    return (
        <ul className={clsx(classes.root, open && "open")}>
            ...
            >
                ...
                {item.badge && (
                    <NavBadge className="mr-4" badge={item.badge} />
                )}
                ...
                <Collapse in={open} className="collapse-children">
                    {
                        item.children.map((item) => (
                            ...
                            <React.Fragment key={item.id}>
                                ...
                                {item.type === 'item' && (
                                    <NavVerticalItem item={item} nestedLevel={nestedLevel + 1} />
                                )}

                                {item.type === 'link' && (
                                    <NavVerticalLink item={item} nestedLevel={nestedLevel + 1} />
                                )}
...
CoreNavVerticalCollapse.propTypes = {
...
CoreNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = withRouter(React.memo(CoreNavVerticalCollapse));
