...
import NavbarMobileToggleFab from 'app/layouts/shared-components/NavbarMobileToggleFab';
...
function NavbarWrapperLayout1(props) {
    ...
    const navbarTheme = useSelector(({ core }) => core.settings.navbarTheme);
    const navbar = useSelector(({ core }) => core.navbar);
