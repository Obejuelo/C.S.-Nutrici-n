...
import {CoreUtils, AnimateGroup} from '@core';
...
function Shortcuts(props) {
    ...
    const navigationData = useSelector(({ core }) => core.navigation);
    ...
    const shortcutItems = shortcuts ? shortcuts.map(id => CoreUtils.findById(navigationData, id)) : [];

    useEffect(() => {
        function flattenNavigation() {
            setNavigation(CoreUtils.getFlatNavigation(navigationData));
        }
