...
import { generateSettings } from 'app/store/reducers/settings/settings.reducer';
...
export default withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(React.memo(Layout))));
