...
const PageCarded = React.forwardRef(function (props, ref) {
            ...
            <div className="flex container w-full">
                ...
                >
                    ...
                    <div className={clsx(classes.contentCard, props.innerScroll && 'inner-scroll')}>
                        ...
                        {props.content && (
                            <Scrollbars className={classes.content} enable={props.innerScroll} scrollToTopOnRouteChange={props.innerScroll}>
                                {props.content}
                            </Scrollbars>
                        )}
                    </div>
