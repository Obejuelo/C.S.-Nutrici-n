...
function CoreNavVerticalGroup(props)
{
                ...
                <React.Fragment>
                    {
                        item.children.map((item) => (
                            ...
                            <React.Fragment key={item.id}>
                                ...
                                {item.type === 'collapse' && (
                                    <NavVerticalCollapse item={item} nestedLevel={nestedLevel}/>
                                )}
                                ...
                                {item.type === 'link' && (
                                    <NavVerticalLink item={item} nestedLevel={nestedLevel}/>
                                )}
...
CoreNavVerticalGroup.propTypes = {
...
CoreNavVerticalGroup.defaultProps = {};

const NavVerticalGroup = withRouter(React.memo(CoreNavVerticalGroup));
