...
const PageSimple = React.forwardRef(function (props, ref) {
        ...
        <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
            ...
            <div className="flex flex-auto flex-col container z-10 h-full">
                ...
                {props.header && props.sidebarInner && (
                    <PageSimpleHeader header={props.header} classes={classes}/>
                )}
                ...
                <div className={classes.wrapper}>
                    ...
                    {/*>*/}
                    <Scrollbars className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
...
export default React.memo(PageSimple);
