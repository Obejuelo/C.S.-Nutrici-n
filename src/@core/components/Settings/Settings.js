...
import {LayoutConfigs} from '@core';
...
function Settings(props) {
    ...
    const themes = useSelector(({ core }) => core.settings.themes);
    const settings = useSelector(({ core }) => core.settings.current);
    ...
    function LayoutConfig() {
        const form = LayoutConfigs[settings.layout.style].form;
        return getForm(form);
    }
